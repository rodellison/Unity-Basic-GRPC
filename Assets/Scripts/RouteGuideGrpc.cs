...
//
// GENERATE the .pb.go and _grpc.pb.go using the following:
// protoc -I routeguide/ routeguide/route_guide.proto --go_out=routeguide --go_opt=paths=source_relative --go-grpc_out=routeguide --go-grpc_opt=paths=source_relative
//
